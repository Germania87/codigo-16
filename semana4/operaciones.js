...
// Para restar 2 number usamos el -
console.log("Restar", numero1 - numero2);
//Para multiplicar  * 
console.log("Multipicar", numero1 * numero2);
//Para dividir el / 
...
console.log("La hipostenusa es", operacion2);
 ...
 //(ejercicio1)
const base = Number(prompt("Dime la base del rectangulo"));
const height = Number(prompt("Dime la altura del rectangulo"));
let RectanglArea = base * height;
console.log("el area del rectangulo es" + " " + RectanglArea ); 


const pi = 3.1416;
const radio = Number(prompt("Dime el valor del radio"));

let CircleArea = Math.pow(radio, 2) * pi;
