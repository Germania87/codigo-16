...
// y usando for o forEach hagan que una variable guarde el cuadradp de las edades

const edades = [5, 10, 22, 8, 31];
const cuadrados = [];
for (let edad of edades) {
    cuadrados.push(edad ** 2);
}
...
const nuevaEdades = [];
edades.forEach((edad) => nuevaEdades.push(Math.pow(edad, 2)));
console.log("nuevasEdades", nuevaEdades);
